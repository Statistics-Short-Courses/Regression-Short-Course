...
-   Here, $\beta_0$ represents the expected value of $Y$ ($E[Y]$) when $X=0$, and
    $\beta_1$ represents the change in $E[Y]$ for a one-unit increase in $X$.
...
ggplot()+
  aes()+
  geom_abline(intercept=5e4, slope=5e3, colour="green")+
