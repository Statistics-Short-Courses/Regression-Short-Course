...
-   **How to diagnose:** Look for clues in the study design and plot residuals in their collection order—long runs of positive or negative residuals hint at dependence.
...
-   **Simulated example:** In this case the assumptions hold—as expected because the data were sampled from an actual linear model.
...
-   **Connection to simulation:** We have been given data sampled from a linear model—consider whether the parameter estimates obtained so far represent the underlying model well.
